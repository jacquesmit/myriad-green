...
- [ ] Replace visible "Irrigation" references in the Weather section with Backup Water Systems wording
- [ ] Update iframe title attribute from "Irrigation" to "Backup Water Services"
- [ ] Update CTA headings and copy that mention "Smart Irrigation" → "Smart Water Monitoring" or similar
- [ ] Update `trust-heading` sr-only text referencing "Irrigation" to "Backup Water Services"
- [ ] Fix testimonial image alt text mismatches
